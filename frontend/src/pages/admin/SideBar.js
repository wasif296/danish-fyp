...
const SideBar = () => {
  ...
  return (
    <>
      <React.Fragment>
        <ListItemButton component={Link} to="/Admin/semesters">
          <ListItemIcon>
            <CalendarMonthIcon
              color={
                location.pathname.startsWith("/Admin/semesters")
                  ? "primary"
                  : "inherit"
              }
            />
        ...
        <ListItemButton component={Link} to="/Admin/feevouchers">
          <ListItemIcon>
            <ReceiptLongIcon
              color={
                location.pathname.startsWith("/Admin/feevouchers")
                  ? "primary"
                  : "inherit"
              }
            />
          </ListItemIcon>
          <ListItemText primary="Fee Vouchers" />
        </ListItemButton>
