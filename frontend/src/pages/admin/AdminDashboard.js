...
import ShowDepartments from "./departmentRelated/ShowDepartments";
import ShowSemesters from "./semesterRelated/ShowSemesters";
import ShowFeeVouchers from "./feeVoucherRelated/ShowFeeVouchers";
import ShowTimetables from "./timetableRelated/ShowTimetables";
import ShowQuizzes from "./quizRelated/ShowQuizzes";
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <Box component="main" sx={styles.boxStyled}>
          ...
          <Routes>
            ...
            {/* Quiz */}
            <Route path="/Admin/quizzes" element={<ShowQuizzes />} />
            ...
            <Route
              ...
              element={<ShowDepartments showNotification={showNotification} />}
            />

            {/* Semester */}
            <Route
              path="/Admin/semesters"
              element={<ShowSemesters showNotification={showNotification} />}
            />

            {/* Fee Voucher */}
            <Route path="/Admin/feevouchers" element={<ShowFeeVouchers />} />
            ...
            <Route
              path="/Admin/classes"
              element={<ShowClasses showNotification={showNotification} />}
            />
            ...
            <Route
              path="/Admin/students"
              element={<ShowStudents showNotification={showNotification} />}
            />
            <Route
            ...
            <Route
              path="/Admin/teachers"
              element={<ShowTeachers showNotification={showNotification} />}
            />
            <Route
